...
function OpportunityFollowUpSub() {

    const [dashboardData, setDashboardData] = useState({ Opportunity: { timeDurationsFollowOpportunity: [], contactsDataFollowOpportunity: [], barChartFirstFollowOpportunity: [] } });
    ...
    const { timeDurationsFollowOpportunity = [], contactsDataFollowOpportunity = [], barChartFirstFollowOpportunity = [] } = dashboardData;
        ...
        <>
            ...
            <div className="todolist-all-area ">
                <div className="todolist-first-area">
                    ...
                    <div className="pb-4">
                        {contactsDataFollowOpportunity.map((contact) => (
                            <VisitAddressContact
                                key={contact.id}
                            ...
                            <section className="text-gray-600 ">
                                <div className="p-4  mx-auto bg-[#f3f4f6] app-header px-7 py-2 ">
                                    <div className="flex flex-wrap -m-4 text-center">
                                        {timeDurationsFollowOpportunity.map((timeDuration, index) => (
                                            <TimeDuration
...
export default OpportunityFollowUpSub;